...
// --- Matching-type questions (rendered as multi-line single-choice options) ---

  {
    ...
    options: [
      { id: "A", text: "P1: Multifaktor-Authentifizierung (MFA) · P2: Passwortlose Authentifizierung · P3: Passwort-Authentifizierung" },
      { id: "B", text: "P1: Passwortauthentifizierung · P2: Multifaktorauthentifizierung (MFA) · P3: Passwortlose Authentifizierung" },
      { id: "C", text: "P1: Passwortlose Authentifizierung · P2: Passwortauthentifizierung · P3: Multifaktor-Authentifizierung (MFA)" },
      { id: "D", text: "P1: Multifaktor-Authentifizierung (MFA) · P2: Passwort-Authentifizierung · P3: Passwortlose Authentifizierung" },
    ],
    correct: "A",
    explanation: "Microsoft empfiehlt kennwortlose Authentifizierungsmethoden wie Windows Hello, Passkeys (FIDO2) und die Microsoft Authenticator-App, da diese die sicherste Anmeldung bieten. Obwohl sich Benutzer mit anderen gängigen Methoden wie Benutzername und Kennwort anmelden können, sollten Kennwörter durch sicherere Authentifizierungsmethoden ersetzt werden. Die mehrstufige Authentifizierung von Microsoft Entra bietet eine zusätzliche Sicherheitsebene im Vergleich zur reinen Kennwortanmeldung eines Benutzers. Der Benutzer kann zu anderen Authentifizierungsformen aufgefordert werden, beispielsweise zur Beantwortung einer Push-Benachrichtigung, zur Eingabe eines Codes von einem Software- oder Hardware-Token oder zur Beantwortung einer Textnachricht oder eines Telefonanrufs."
  },
  {
    id: "real-match-556",
    topicId: "cloud-konzepte",
    prompt: "Ordnen Sie den Cloud-Dienst der entsprechenden Beschreibung zu.",
    options: [
      { id: "A", text: "Bietet die größtmögliche Kontrolle über eine Cloud-Umgebung: Infrastructure as a Service (IaaS) · Bietet die größtmögliche Kontrolle über ein Datenbankdesign, ohne das Betriebssystem warten zu müssen: Software as a Service (SaaS) · Wird zum Hosten von virtuellen Azure-Computern verwendet: Platform as a Service (PaaS)" },
      { id: "B", text: "Bietet die größtmögliche Kontrolle über eine Cloud-Umgebung: Infrastructure as a Service (IaaS) · Bietet die größtmögliche Kontrolle über ein Datenbankdesign, ohne das Betriebssystem warten zu müssen: Platform as a Service (PaaS) · Wird zum Hosten virtueller Azure-Computer verwendet: Infrastructure as a Service (IaaS)" },
      { id: "C", text: "Bietet die größtmögliche Kontrolle über eine Cloud-Umgebung: Platform as a Service (PaaS) · Bietet die größtmögliche Kontrolle über ein Datenbankdesign, ohne das Betriebssystem warten zu müssen: Software as a Service (SaaS) · Wird zum Hosten virtueller Azure-Computer verwendet: Software as a Service (SaaS)" },
      { id: "D", text: "Bietet die größtmögliche Kontrolle über eine Cloud-Umgebung: Platform as a Service (PaaS) · Bietet die größtmögliche Kontrolle über ein Datenbankdesign, ohne das Betriebssystem warten zu müssen: Platform as a Service (PaaS) · Wird zum Hosten virtueller Azure-Computer verwendet: Infrastructure as a Service (IaaS)" },
      { id: "E", text: "Bietet die größtmögliche Kontrolle über eine Cloud-Umgebung: Software as a Service (SaaS) · Bietet die größtmögliche Kontrolle über ein Datenbankdesign, ohne das Betriebssystem warten zu müssen: Infrastructure as a Service (IaaS) · Wird zum Hosten virtueller Azure-Computer verwendet: Infrastructure as a Service (IaaS)" },
      { id: "F", text: "Bietet die größtmögliche Kontrolle über eine Cloud-Umgebung: Infrastructure as a Service (IaaS) · Bietet die größtmögliche Kontrolle über ein Datenbankdesign, ohne das Betriebssystem warten zu müssen: Software as a Service (SaaS) · Wird zum Hosten von virtuellen Azure-Computern verwendet: Platform as a Service (PaaS)" },
    ],
    correct: "B",
    explanation: "Software as a Service (SaaS) ist ein Softwarelizenzierungs- und Bereitstellungsmodell, bei dem Software an einen Benutzer lizenziert wird. Der Zugriff auf die Software bzw. Anwendung erfolgt über das Internet und einen Webbrowser. Sie müssen die Software nicht lokal installieren und warten. Sie können sofort mit der Konfiguration und Nutzung beginnen. Infrastructure as a Service (IaaS) ist ein Cloud-Computing-Dienst, der wichtige Rechen-, Speicher- und Netzwerkressourcen bedarfsgerecht und nutzungsbasiert bereitstellt. Mit IaaS sparen Sie sich die Kosten und den Aufwand für den Kauf und die Verwaltung physischer Server und Rechenzentrumsinfrastruktur. Jede Ressource wird als separate Servicekomponente angeboten, und Sie zahlen nur für die jeweilige Ressource, solange Sie sie benötigen. Ein Cloud-Computing-Dienstanbieter wie Azure verwaltet die Infrastruktur, während Sie Ihre eigene Software – einschließlich Betriebssystemen, Middleware und Anwendungen – kaufen, installieren, konfigurieren und verwalten. Wie IaaS umfasst PaaS Infrastruktur – Server, Speicher und Netzwerk –, aber auch Middleware, Entwicklungstools, Business Intelligence (BI)-Dienste, Datenbankmanagementsysteme und mehr. Azure Backup ist ein Beispiel für eine PaaS-Lösung. Referenzen: Was ist PaaS? Was ist IaaS? Was ist SaaS?"
  },
  {
    ...
    options: [
      { id: "A", text: "Azure Container Instances bietet eine Softwareemulation eines physischen Computers. · Azure App Service bietet eine Betriebssystemvirtualisierung." },
      { id: "B", text: "Der Azure App-Dienst bietet eine Softwareemulation eines physischen Computers. · Azure Container Instances bietet eine Betriebssystemvirtualisierung." },
      { id: "C", text: "Azure Virtual Machine Scale Sets ermöglicht die Softwareemulation eines physischen Computers. · Azure Container Instances ermöglicht die Virtualisierung des Betriebssystems." },
      { id: "D", text: "Azure Functions ermöglicht die Softwareemulation eines physischen Computers. · Azure Virtual Machine Scale Sets ermöglicht die Virtualisierung des Betriebssystems." },
      { id: "E", text: "Azure Functions bietet eine Softwareemulation eines physischen Computers. · Azure App Service bietet eine Betriebssystemvirtualisierung." },
      { id: "F", text: "Azure Container Instances ermöglicht die Softwareemulation eines physischen Computers. · Azure Virtual Machine Scale Sets ermöglicht die Virtualisierung des Betriebssystems." },
    ],
    correct: "F",
    explanation: "Azure Container Instances ist eine hervorragende Lösung für alle Szenarien, die isolierte Container erfordern, darunter einfache Anwendungen, Aufgabenautomatisierung und Buildaufträge. Container bieten gegenüber virtuellen Maschinen (VMs) erhebliche Startvorteile. Azure Container Instances starten Container in Azure in Sekundenschnelle, ohne dass VMs bereitgestellt und verwaltet werden müssen. Azure Container Instances garantiert, dass Ihre Anwendung in einem Container genauso isoliert ist wie in einer VM. Mit Azure Virtual Machine Scale Sets können Sie eine Gruppe von virtuellen Maschinen mit Lastenausgleich erstellen und verwalten. Die Anzahl der VM-Instanzen kann je nach Bedarf oder Zeitplan automatisch erhöht oder verringert werden. Referenzen: Was sind Azure Container Instances? Was sind Virtual Machine Scale Sets?"
  },
  {
    id: "real-match-466",
    topicId: "azure-architektur",
    ...
    options: [
      { id: "A", text: "P1: ExpressRoute · P2: VPN-Gateway · P3: Virtuelles Netzwerk-Peering" },
      { id: "B", text: "P1: ExpressRoute · P2: Virtuelles Netzwerk-Peering · P3: VPN-Gateway" },
      { id: "C", text: "P1: Virtuelles Netzwerk-Peering · P2: VPN-Gateway · P3: ExpressRoute" },
      { id: "D", text: "P1: Virtuelles Netzwerk-Peering · P2: ExpressRoute · P3: VPN-Gateway" },
      { id: "E", text: "P1: VPN-Gateway · P2: Virtuelles Netzwerk-Peering · P3: ExpressRoute" },
      { id: "F", text: "P1: VPN-Gateway · P2: ExpressRoute · P3: Virtuelles Netzwerk-Peering" },
    ],
    correct: "B",
    explanation: "Mit ExpressRoute können Sie Ihre lokalen Netzwerke mithilfe eines Konnektivitätsanbieters über eine private Verbindung in die Microsoft-Cloud erweitern. Mit ExpressRoute können Sie Verbindungen zu Microsoft-Clouddiensten wie Microsoft Azure und Microsoft 365 herstellen. Die Konnektivität kann über ein Any-to-Any-Netzwerk (IP VPN), ein Point-to-Point-Ethernet-Netzwerk oder eine virtuelle Querverbindung über einen Konnektivitätsanbieter in einer Colocation-Einrichtung erfolgen. ExpressRoute-Verbindungen laufen nicht über das öffentliche Internet. Dadurch bieten ExpressRoute-Verbindungen mehr Zuverlässigkeit, höhere Geschwindigkeiten, konsistente Latenzen und höhere Sicherheit als typische Verbindungen über das Internet. Mithilfe von virtuellem Netzwerk-Peering können Sie zwei oder mehr virtuelle Netzwerke in Azure nahtlos miteinander verbinden. Die virtuellen Netzwerke werden aus Konnektivitätsgründen als ein einziges Netzwerk angezeigt. Der Datenverkehr zwischen virtuellen Computern in virtuellen Peering-Netzwerken nutzt die Microsoft-Backbone- Infrastruktur. Wie der Datenverkehr zwischen virtuellen Computern im selben Netzwerk wird auch dieser ausschließlich über das private Netzwerk von Microsoft geleitet. Azure VPN Gateway ist ein Dienst, der einen bestimmten Typ von virtuellem Netzwerkgateway verwendet, um verschlüsselten Datenverkehr zwischen einem virtuellen Azure-Netzwerk und lokalen Standorten über das öffentliche Internet zu senden. Sie können VPN Gateway auch verwenden, um verschlüsselten Datenverkehr zwischen virtuellen Azure-Netzwerken über das Microsoft-Netzwerk zu senden. Es können mehrere Verbindungen zum selben VPN-Gateway hergestellt werden. Wenn Sie mehrere Verbindungen erstellen, teilen sich alle VPN-Tunnel die verfügbare Gateway-Bandbreite. Referenzen: Was ist Azure ExpressRoute? Virtuelles Netzwerk-Peering. Was ist Azure VPN Gateway?"
  },
  {
    id: "real-match-451",
    topicId: "azure-architektur",
    ...
    options: [
      { id: "A", text: "P1: Notfallwiederherstellung · P2: Geoverteilung · P3: Hohe Verfügbarkeit" },
      { id: "B", text: "P1: Notfallwiederherstellung · P2: Hohe Verfügbarkeit · P3: Skalierbarkeit" },
      { id: "C", text: "P1: Geo-Verteilung · P2: Skalierbarkeit · P3: Notfallwiederherstellung" },
      { id: "D", text: "P1: Hohe Verfügbarkeit · P2: Geo-Verteilung · P3: Skalierbarkeit" },
      { id: "E", text: "P1: Hohe Verfügbarkeit · P2: Skalierbarkeit · P3: Geo-Verteilung" },
      { id: "F", text: "P1: Skalierbarkeit · P2: Hohe Verfügbarkeit · P3: Geo-Verteilung" },
    ],
    correct: "D",
    explanation: "Hochverfügbarkeit bezeichnet eine Reihe von Technologien, die IT-Unterbrechungen minimieren, indem sie die Geschäftskontinuität von IT-Diensten durch redundante, fehlertolerante oder failover-geschützte Komponenten innerhalb desselben Rechenzentrums gewährleisten . In unserem Fall befindet sich das Rechenzentrum innerhalb einer Azure-Region. Disaster Recovery bezeichnet die Minimierung von IT-Serviceunterbrechungen und deren Wiederherstellung, allerdings über verschiedene Rechenzentren hinweg, die Hunderte von Kilometern voneinander entfernt sein können. In unserem Fall können sich die Rechenzentren in verschiedenen Azure-Regionen innerhalb derselben geopolitischen Region oder an von Ihnen als Kunde festgelegten Standorten befinden. Mit dem geografisch verteilten Muster erstreckt sich Ihre App über mehrere Regionen. Sie können standardmäßig die öffentliche Cloud verwenden, einige Ihrer Benutzer legen jedoch möglicherweise Wert darauf, dass ihre Daten in ihrer Region verbleiben. Sie können Benutzer je nach ihren Anforderungen zur am besten geeigneten Cloud weiterleiten. Skalierbarkeit ist die Fähigkeit eines Systems, erhöhte Lasten zu bewältigen. Von Azure Autoscale abgedeckte Dienste können automatisch skaliert werden, um der Nachfrage gerecht zu werden und die Arbeitslast zu bewältigen. Diese Dienste werden skaliert, um die Kapazität während Arbeitslastspitzen sicherzustellen, und kehren automatisch zum Normalzustand zurück, wenn die Spitze abfällt. Referenzen: Direkter Datenverkehr mit einer geografisch verteilten App unter Verwendung von Azure und Azure Stack Hub Design für die Skalierung"
  },
  {
    id: "real-match-449",
    topicId: "azure-architektur",
    ...
    options: [
      { id: "A", text: "P1: Azure Active Directory (Azure AD) · P2: Azure Lighthouse · P3: Microsoft Sentinel" },
      { id: "B", text: "P1: Azure Lighthouse · P2: Microsoft Defender für Cloud · P3: Azure Active Directory (Azure AD)" },
      { id: "C", text: "P1: Azure Lighthouse · P2: Microsoft Sentinel · P3: Azure Key Vault" },
      { id: "D", text: "P1: Microsoft Defender für Cloud · P2: Azure Lighthouse · P3: Microsoft Sentinel" },
      { id: "E", text: "P1: Microsoft Defender für Cloud · P2: Microsoft Sentinel · P3: Azure Active Directory (Azure AD)" },
      { id: "F", text: "P1: Microsoft Sentinel · P2: Microsoft Defender für Cloud · P3: Azure Key Vault" },
    ],
    correct: "F",
    explanation: "Microsoft Sentinel ist eine skalierbare, Cloud-native Lösung, die Folgendes bietet: • Sicherheitsinformations- und Ereignismanagement (SIEM) • Sicherheitsorchestrierung, -automatisierung und -reaktion (SOAR) Microsoft Sentinel bietet intelligente Sicherheitsanalysen und Bedrohungsinformationen für das gesamte Unternehmen. Mit Microsoft Sentinel erhalten Sie eine zentrale Lösung für Angriffserkennung, Bedrohungstransparenz, proaktive Bedrohungssuche und Bedrohungsreaktion. • Sammeln Sie Daten im Cloud-Maßstab über alle Benutzer, Geräte, Anwendungen und Infrastrukturen hinweg, sowohl vor Ort als auch in mehreren Clouds. • Erkennen Sie bisher unentdeckte Bedrohungen und minimieren Sie Fehlalarme mithilfe der Analysefunktionen und beispiellosen Bedrohungsinformationen von Microsoft. • Untersuchen Sie Bedrohungen mit künstlicher Intelligenz und suchen Sie in großem Umfang nach verdächtigen Aktivitäten, indem Sie auf die jahrelange Erfahrung von Microsoft im Bereich Cybersicherheit zurückgreifen. • Reagieren Sie schnell auf Vorfälle mit integrierter Orchestrierung und Automatisierung gängiger Aufgaben. Microsoft Defender für Cloud ist eine cloudnative Anwendungsschutzplattform (CNAPP) mit einer Reihe von Sicherheitsmaßnahmen und -verfahren zum Schutz cloudbasierter Anwendungen vor verschiedenen Cyberbedrohungen und Sicherheitsrisiken. Defender für Cloud kombiniert die folgenden Funktionen: • Eine Lösung für Entwicklungssicherheitsoperationen (DevSecOps), die das Sicherheitsmanagement auf Codeebene in Multicloud- und Multi-Pipeline- Umgebungen vereinheitlicht • Eine Lösung für das Cloud Security Posture Management (CSPM), die Maßnahmen aufzeigt, die Sie ergreifen können, um Sicherheitsverletzungen zu verhindern • Eine Cloud Workload Protection Platform (CWPP) mit spezifischem Schutz für Server, Container, Speicher, Datenbanken und andere Workloads Azure Key Vault ist eine von mehreren Schlüsselverwaltungslösungen in Azure und hilft bei der Lösung der folgenden Probleme: • Geheimnisverwaltung – Azure Key Vault kann verwendet werden, um Token, Passwörter, Zertifikate, API-Schlüssel und andere Geheimnisse sicher zu speichern und den Zugriff darauf streng zu kontrollieren. • Schlüsselverwaltung: Azure Key Vault kann als Schlüsselverwaltungslösung verwendet werden. Azure Key Vault erleichtert das Erstellen und Verwalten der Verschlüsselungsschlüssel, die zum Verschlüsseln Ihrer Daten verwendet werden. • Zertifikatsverwaltung – Mit Azure Key Vault können Sie öffentliche und private Transport Layer Security/Secure Sockets Layer (TLS/SSL)-Zertifikate für die Verwendung mit Azure und Ihren intern verbundenen Ressourcen einfach bereitstellen, verwalten und einsetzen. Referenzen: Was ist Microsoft Sentinel? Was ist Microsoft Defender für die Cloud? Informationen zu Azure Key Vault"
  },
  {
    id: "real-match-434",
    topicId: "cloud-konzepte",
    prompt: "Ordnen Sie die Cloud-Service-Modelle den passenden Lösungen zu.",
    options: [
      { id: "A", text: "Ein Cloud-basierter Dateiserver: Infrastructure as a Service (IaaS) · Ein Cloud-basiertes Buchhaltungssystem: Platform as a Service (PaaS) · Ein Cloud-basierter Dienst für benutzerdefinierte Apps: Software as a Service (SaaS)" },
      { id: "B", text: "Ein Cloud-basierter Dateiserver: Infrastructure as a Service (IaaS) · Ein Cloud-basiertes Buchhaltungssystem: Software as a Service (SaaS) · Ein Cloud-basierter Dienst für benutzerdefinierte Apps: Platform as a Service (PaaS)" },
      { id: "C", text: "Ein Cloud-basierter Dateiserver: Platform as a Service (PaaS) · Ein Cloud-basiertes Buchhaltungssystem: Infrastructure as a Service (IaaS) · Ein Cloud-basierter Dienst für benutzerdefinierte Apps: Software as a Service (SaaS)" },
      { id: "D", text: "Ein Cloud-basierter Dateiserver: Platform as a Service (PaaS) · Ein Cloud-basiertes Buchhaltungssystem: Software as a Service (SaaS) · Ein Cloud-basierter Dienst für benutzerdefinierte Apps: Infrastructure as a Service (IaaS)" },
      { id: "E", text: "Ein Cloud-basierter Dateiserver: Software as a Service (SaaS) · Ein Cloud-basiertes Buchhaltungssystem: Infrastructure as a Service (IaaS) · Ein Cloud-basierter Dienst für benutzerdefinierte Apps: Platform as a Service (PaaS)" },
      { id: "F", text: "Ein Cloud-basierter Dateiserver: Software as a Service (SaaS) · Ein Cloud-basiertes Buchhaltungssystem: Platform as a Service (PaaS) · Ein Cloud-basierter Dienst für benutzerdefinierte Apps: Infrastructure as a Service (IaaS)" },
    ],
    correct: "B",
    explanation: "Platform as a Service (PaaS) ist eine umfassende Entwicklungs- und Bereitstellungsumgebung in der Cloud mit Ressourcen, die Ihnen die Bereitstellung von Anwendungen aller Art ermöglichen – von einfachen Cloud-basierten Apps bis hin zu komplexen, Cloud-fähigen Unternehmensanwendungen. Sie erwerben die benötigten Ressourcen von einem Cloud-Service-Anbieter auf Pay-as-you-go-Basis und greifen über eine sichere Internetverbindung darauf zu. Wie IaaS umfasst PaaS die Infrastruktur – Server, Speicher und Netzwerke –, aber auch Middleware, Entwicklungstools, Business Intelligence (BI)-Dienste, Datenbankmanagementsysteme und mehr. PaaS unterstützt den gesamten Lebenszyklus von Webanwendungen: Erstellen, Testen, Bereitstellen, Verwalten und Aktualisieren. Mit PaaS sparen Sie sich die Kosten und den Aufwand für den Kauf und die Verwaltung von Softwarelizenzen, der zugrunde liegenden Anwendungsinfrastruktur und Middleware, Container-Orchestratoren wie Kubernetes oder der Entwicklungstools und anderer Ressourcen. Sie verwalten die von Ihnen entwickelten Anwendungen und Dienste, und der Cloud-Service-Anbieter kümmert sich in der Regel um alles Weitere. Durch die Bereitstellung von Infrastructure as a Service bietet PaaS dieselben Vorteile wie IaaS. Die zusätzlichen Funktionen – Middleware, Entwicklungstools und andere Business-Tools – bieten Ihnen jedoch weitere Vorteile. Software as a Service (SaaS) ist ein Softwarelizenzierungs- und Bereitstellungsmodell, bei dem Software an einen Benutzer lizenziert wird. Der Zugriff auf die Software bzw. Anwendung erfolgt über das Internet und einen Webbrowser. Sie müssen die Software nicht lokal installieren und warten. Sie können sofort mit der Konfiguration und Nutzung beginnen. Infrastructure as a Service (IaaS) ist ein Cloud-Computing-Dienst, der wichtige Rechen-, Speicher- und Netzwerkressourcen bedarfsgerecht und nutzungsbasiert bereitstellt. Mit IaaS sparen Sie sich die Kosten und den Aufwand für den Kauf und die Verwaltung physischer Server und Rechenzentrumsinfrastruktur. Jede Ressource wird als separate Servicekomponente angeboten, und Sie zahlen nur für die jeweilige Ressource, solange Sie sie benötigen. Ein Cloud-Computing-Dienstanbieter wie Azure verwaltet die Infrastruktur, während Sie Ihre eigene Software – einschließlich Betriebssysteme, Middleware und Anwendungen – kaufen, installieren, konfigurieren und verwalten. Microsoft SQL Server 2019, installiert auf einer virtuellen Azure-Maschine, ist ein Beispiel für Infrastructure as a Service (IaaS). Azure Cosmos DB ist ein Beispiel für einen Platform as a Service (PaaS)-Cloud-Datenbankanbieter. Referenzen: Was ist PaaS? Was ist IaaS? Was ist SaaS?"
  },
  {
    ...
    options: [
      { id: "A", text: "P1: Azure Cosmos DB · P2: Azure HDInsight · P3: Azure Synapse Analytics" },
      { id: "B", text: "P1: Azure Cosmos DB · P2: Azure Synapse Analytics · P3: Azure HDInsight" },
      { id: "C", text: "P1: Azure HDInsight · P2: Azure Synapse Analytics · P3: Azure Cosmos DB" },
      { id: "D", text: "P1: Azure HDInsight · P2: Azure Cosmos DB · P3: Azure Synapse Analytics" },
      { id: "F", text: "P1: Azure Synapse Analytics · P2: Azure HDInsight · P3: Azure Cosmos DB · P1: Azure Synapse Analytics · P2: Azure Cosmos DB · P3: Azure HDInsight" },
    ],
    correct: "F",
    explanation: "Azure HDInsight ist eine Cloud-Distribution von Hadoop-Komponenten. Azure HDInsight ermöglicht die einfache, schnelle und kostengünstige Verarbeitung riesiger Datenmengen. Sie können die gängigsten Open-Source-Frameworks wie Hadoop, Spark, Hive, LLAP, Kafka, Storm, R und mehr verwenden. Mit diesen Frameworks können Sie eine breite Palette von Szenarien wie Extrahieren, Transformieren und Laden (ETL), Data Warehousing, maschinelles Lernen und IoT ermöglichen. Azure Synapse Analytics ist ein integrierter Analysedienst, der die Zeit bis zur Erkenntnisgewinnung über Data Warehouses und Big Data- Systeme hinweg verkürzt. Azure Synapse vereint die besten SQL-Technologien für Enterprise Data Warehousing, Spark-Technologien für Big Data und Pipelines für Datenintegration und ETL/ELT. Synapse Studio bietet eine einheitliche Oberfläche für Verwaltung, Überwachung, Codierung und Sicherheit. Synapse ist tief in andere Azure-Dienste wie PowerBI, CosmosDB und AzureML integriert. Azure Cosmos DB ist eine vollständig verwaltete NoSQL-Datenbank für die moderne App-Entwicklung. Reaktionszeiten im einstelligen Millisekundenbereich sowie automatische und sofortige Skalierbarkeit garantieren Geschwindigkeit in jedem Maßstab. Geschäftskontinuität wird durch SLA-gestützte Verfügbarkeit und Sicherheit auf Unternehmensniveau gewährleistet. Die App-Entwicklung wird dank schlüsselfertiger, regionsübergreifender Datenverteilung weltweit sowie Open-Source-APIs und SDKs für gängige Sprachen schneller und produktiver. Als vollständig verwalteter Dienst nimmt Ihnen Azure Cosmos DB die Datenbankadministration mit automatischer Verwaltung, Updates und Patches ab. Darüber hinaus übernimmt es das Kapazitätsmanagement mit kostengünstigen serverlosen und automatischen Skalierungsoptionen, die auf Anwendungsanforderungen reagieren und die Kapazität an den Bedarf anpassen."
  },
  {
    id: "real-match-366",
    topicId: "cloud-konzepte",
    ...
    options: [
      { id: "A", text: "P1: Agilität · P2: Notfallwiederherstellung · P3: Elastizität" },
      { id: "B", text: "P1: Agilität · P2: Elastizität · P3: Notfallwiederherstellung" },
      { id: "C", text: "P1: Notfallwiederherstellung · P2: Agilität · P3: Elastizität" },
      { id: "D", text: "P1: Notfallwiederherstellung · P2: Elastizität · P3: Agilität" },
      { id: "E", text: "P1: Elastizität · P2: Agilität · P3: Notfallwiederherstellung" },
      { id: "F", text: "P1: Elastizität · P2: Notfallwiederherstellung · P3: Agilität" },
    ],
    correct: "F",
    explanation: "Skalierung und Elastizität ermöglichen Ihnen, leicht mit sich ändernden Leistungsanforderungen umzugehen. Skalierung ist der Prozess, bei dem Ihrer Anwendung zusätzliche Ressourcen oder zusätzliche Leistung hinzugefügt werden. Es gibt zwei Arten der Skalierung: horizontale Skalierung (oft als „Skalierung nach außen“ bezeichnet) und vertikale Skalierung (oft als „Skalierung nach oben“ bezeichnet). Bei der Skalierung nach außen fügen Sie Ihrer Anwendung zusätzliche VMs hinzu. Jede hinzugefügte VM ist identisch mit anderen VMs, die Ihre Anwendung bedienen. Durch die Skalierung nach außen werden zusätzliche Ressourcen bereitgestellt, um zusätzliche Last zu bewältigen. Bei der Skalierung nach oben wechseln Sie zu einer neuen VM mit zusätzlichen Ressourcen. Sie stellen beispielsweise möglicherweise fest, dass Sie für Ihre Anwendung eine leistungsstärkere CPU und mehr Speicher benötigen. In diesem Fall ermöglicht Ihnen die Skalierung nach oben, Ihre Anwendung auf eine leistungsstärkere VM zu verschieben. Diese Art von Geschwindigkeit und Flexibilität in der Cloud wird oft als Cloud -Agilität bezeichnet . Disaster Recovery bedeutet nicht nur zuverlässige Backups wichtiger Daten, sondern auch, dass die Cloud-Infrastruktur die Ressourcen Ihrer Anwendung in einer nicht betroffenen Region replizieren kann, sodass Ihre Daten sicher sind und die Verfügbarkeit Ihrer Anwendung nicht beeinträchtigt wird. Disaster-Recovery-Pläne werden allgemein als Business-Continuity- und Disaster-Recovery-Pläne (BCDR) bezeichnet. Die meisten Cloud-Anbieter bieten Dienste an, die Sie bei der Entwicklung und Implementierung eines auf Ihre Bedürfnisse zugeschnittenen Plans unterstützen."
  },
  {
    id: "real-match-365",
    topicId: "azure-architektur",
    prompt: "Ordnen Sie die Sicherheitskomponenten den entsprechenden Tiefenverteidigungsebenen zu.",
    options: [
      { id: "B", text: "Computing: Multifaktor-Authentifizierung (MFA) · Identität und Zugriff: Software-Updates und Patches · Physische Sicherheit: Überwachungskamera · Computing: Multifaktor-Authentifizierung (MFA) · Identität und Zugriff: Überwachungskamera · Physische Sicherheit: Software-Updates und Patches" },
      { id: "C", text: "Computing: Software-Updates und Patches · Identität und Zugriff: Multifaktor-Authentifizierung (MFA) · Physische Sicherheit: Überwachungskamera" },
      { id: "D", text: "Computing: Software-Updates und Patches · Identität und Zugriff: Überwachungskamera · Physische Sicherheit: Multifaktor-Authentifizierung (MFA)" },
      { id: "E", text: "Computing: Überwachungskamera · Identität und Zugriff: Multifaktor-Authentifizierung (MFA) · Physische Sicherheit: Software-Updates und Patches" },
      { id: "F", text: "Computing: Überwachungskamera · Identität und Zugriff: Software-Updates und Patches · Physische Sicherheit: Multifaktor-Authentifizierung (MFA)" },
    ],
    correct: "C",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Disaster Recovery erhöht die Rechenkapazität von Apps in der Cloud. · Geo-Distribution sorgt für ein kontinuierliches Benutzererlebnis ohne sichtbare Ausfallzeiten. · Hohe Verfügbarkeit stellt sicher, dass Benutzer stets das beste Erlebnis haben, indem Apps in allen Regionen bereitgestellt werden, in denen sich · Benutzer befinden." },
      { id: "B", text: "Geo-Distribution erhöht die Rechenkapazität von Apps in der Cloud. · Hohe Verfügbarkeit sorgt für ein kontinuierliches Benutzererlebnis ohne sichtbare Ausfallzeiten. · Skalierbarkeit stellt sicher, dass Benutzer immer das beste Erlebnis haben, indem Apps in allen Regionen bereitgestellt werden, in denen es Benutzer · gibt." },
      { id: "C", text: "Skalierbarkeit erhöht die Rechenkapazität von Apps in der Cloud. · Disaster Recovery sorgt für ein kontinuierliches Benutzererlebnis ohne sichtbare Ausfallzeiten. · Geo-Distribution stellt sicher, dass Benutzer stets das beste Erlebnis haben, indem Apps in allen Regionen bereitgestellt werden, in denen es · Benutzer gibt." },
      { id: "E", text: "Geo-Distribution erhöht die Rechenkapazität von Apps in der Cloud. · Skalierbarkeit sorgt für ein kontinuierliches Benutzererlebnis ohne sichtbare Ausfallzeiten. · Disaster Recovery stellt sicher, dass Benutzer stets das beste Erlebnis haben, indem Apps in allen Regionen bereitgestellt werden, in denen Benutzer · vorhanden sind. · Skalierbarkeit erhöht die Rechenkapazität von Apps in der Cloud. · Hohe Verfügbarkeit sorgt für ein kontinuierliches Benutzererlebnis ohne sichtbare Ausfallzeiten. · Geo-Distribution stellt sicher, dass Benutzer immer das beste Erlebnis haben, indem Apps in allen Regionen bereitgestellt werden, in denen es · Benutzer gibt." },
      { id: "F", text: "Hohe Verfügbarkeit erhöht die Rechenkapazität von Apps in der Cloud. · Disaster Recovery sorgt für ein kontinuierliches Benutzererlebnis ohne sichtbare Ausfallzeiten. · Skalierbarkeit sorgt dafür, dass Benutzer stets das beste Erlebnis haben, indem Apps in allen Regionen bereitgestellt werden, in denen Benutzer · vorhanden sind." },
    ],
    correct: "E",
    explanation: "Eine Cloud-Umgebung bietet gegenüber einer physischen Umgebung mehrere Vorteile: • Hohe Verfügbarkeit: Abhängig von der von Ihnen gewählten Service-Level-Vereinbarung (SLA) können Ihre Cloud-basierten Apps ein kontinuierliches Benutzererlebnis ohne erkennbare Ausfallzeiten bieten, selbst wenn etwas schiefgeht. • Skalierbarkeit: Apps in der Cloud können vertikal und horizontal skaliert werden : o Skalieren Sie vertikal, um die Rechenkapazität zu erhöhen, indem Sie einer virtuellen Maschine RAM oder CPUs hinzufügen. o Durch horizontales Skalieren wird die Rechenkapazität durch das Hinzufügen von Ressourceninstanzen erhöht, beispielsweise durch das Hinzufügen von VMs zur Konfiguration. • Elastizität: Sie können Cloud-basierte Apps so konfigurieren, dass sie die Vorteile der automatischen Skalierung nutzen, sodass Ihre Apps immer über die Ressourcen verfügen, die sie benötigen. • Agilität: Stellen Sie cloudbasierte Ressourcen schnell bereit und konfigurieren Sie sie, wenn sich die Anforderungen Ihrer App ändern. • Geo-Verteilung: Sie können Apps und Daten in regionalen Rechenzentren auf der ganzen Welt bereitstellen und so sicherstellen, dass Ihre Kunden in ihrer Region immer die beste Leistung erhalten. • Notfallwiederherstellung: Durch die Nutzung cloudbasierter Sicherungsdienste, Datenreplikation und Geoverteilung können Sie Ihre Apps mit der Gewissheit bereitstellen, dass Ihre Daten im Katastrophenfall sicher sind."
  },
  {
    id: "real-match-327",
    topicId: "cloud-konzepte",
    prompt: "Ordnen Sie die Cloud-Service-Modelle den passenden Angeboten zu.",
    options: [
      { id: "A", text: "Azure App Service: Infrastruktur als Service (IaaS) · Azure Virtual Machines: Plattform als Service (PaaS) · Microsoft Dynamics 365: Software als Service (SaaS)" },
      { id: "B", text: "Azure App Service: Infrastruktur als Service (IaaS) · Azure Virtual Machines: Software als Service (SaaS) · Microsoft Dynamics 365: Plattform als Service (PaaS)" },
      { id: "C", text: "Azure App Service: Plattform als Service (PaaS) · Azure Virtual Machines: Infrastruktur als Service (IaaS) · Microsoft Dynamics 365: Software als Service (SaaS)" },
      { id: "D", text: "Azure App Service: Plattform als Service (PaaS) · Azure Virtual Machines: Software als Service (SaaS) · Microsoft Dynamics 365: Infrastruktur als Service (IaaS)" },
      { id: "E", text: "Azure App Service: Software as a Service (SaaS) · Azure Virtual Machines: Infrastructure as a Service (IaaS) · Microsoft Dynamics 365: Platform as a Service (PaaS)" },
      { id: "F", text: "Azure App Service: Software as a Service (SaaS) · Azure Virtual Machines: Platform as a Service (PaaS) · Microsoft Dynamics 365: Infrastructure as a Service (IaaS)" },
    ],
    correct: "C",
    explanation: "Software as a Service (SaaS) ist ein Softwarelizenzierungs- und Bereitstellungsmodell, bei dem Software an einen Benutzer lizenziert wird. Der Zugriff auf die Software bzw. Anwendung erfolgt über das Internet und einen Webbrowser. Sie müssen die Software nicht lokal installieren und warten. Sie können sofort mit der Konfiguration und Nutzung beginnen. Infrastructure as a Service (IaaS) ist ein Cloud-Computing-Dienst, der wichtige Rechen-, Speicher- und Netzwerkressourcen bedarfsgerecht und nutzungsbasiert bereitstellt. Mit IaaS sparen Sie sich die Kosten und den Aufwand für den Kauf und die Verwaltung physischer Server und Rechenzentrumsinfrastruktur. Jede Ressource wird als separate Servicekomponente angeboten, und Sie zahlen nur für die jeweilige Ressource, solange Sie sie benötigen. Ein Cloud-Computing-Dienstanbieter wie Azure verwaltet die Infrastruktur, während Sie Ihre eigene Software – einschließlich Betriebssystemen, Middleware und Anwendungen – kaufen, installieren, konfigurieren und verwalten. Wie IaaS umfasst PaaS Infrastruktur – Server, Speicher und Netzwerk –, aber auch Middleware, Entwicklungstools, Business Intelligence (BI)-Dienste, Datenbankmanagementsysteme und mehr. Azure Backup ist ein Beispiel für eine PaaS-Lösung. Referenzen: Was ist PaaS? Was ist IaaS? Was ist SaaS?"
  },
  {
    ...
    prompt: "Ordnen Sie die Ressourcen den entsprechenden Beschreibungen zu.",
    options: [
      { id: "A", text: "P1: Nachtrag zum Datenschutz · P2: Microsoft-Datenschutzerklärung · P3: Bedingungen für Onlinedienste" },
      { id: "B", text: "P1: Nachtrag zum Datenschutz · P2: Bedingungen für Onlinedienste · P3: Datenschutzerklärung von Microsoft" },
      { id: "C", text: "P1: Microsoft-Datenschutzerklärung · P2: Nachtrag zum Datenschutz · P3: Bedingungen für Onlinedienste" },
      { id: "D", text: "P1: Microsoft-Datenschutzerklärung · P2: Online-Servicebedingungen · P3: Nachtrag zum Datenschutz" },
      { id: "E", text: "P1: Bedingungen für Onlinedienste · P2: Nachtrag zum Datenschutz · P3: Datenschutzerklärung von Microsoft" },
      { id: "F", text: "P1: Online-Servicebedingungen · P2: Microsoft-Datenschutzerklärung · P3: Nachtrag zum Datenschutz" },
    ],
    correct: "C",
    explanation: "Die Microsoft-Datenschutzerklärung erläutert, welche personenbezogenen Daten Microsoft verarbeitet, wie Microsoft sie verarbeitet und zu welchen Zwecken. Ihr geltender Servicevertrag oder die zusätzlichen Bedingungen für die Vorschau können für einige Vorschaudienste geringere oder andere Datenschutzmaßnahmen vorsehen. Der Nachtrag zum Datenschutz für Onlinedienste („DPA“) legt Ihre und Microsofts Verpflichtungen hinsichtlich der Verarbeitung und Sicherheit von Kundendaten und personenbezogenen Daten in Verbindung mit Azure fest. Der Abschnitt „Datenschutz- und Sicherheitsbedingungen für Onlinedienste“ auf der Website mit den Produktbedingungen enthält weitere Ausnahmen vom DPA sowie zusätzliche Verpflichtungen für zentrale Onlinedienste. Das Microsoft Trust Center bietet Kunden von Azure und anderen Microsoft-Onlinediensten weitere Informationen zu den Themen Sicherheit, Datenschutz und Compliance. Das Service Trust Portal (STP) ist eine Ergänzung zum Trust Center und bietet Zugriff auf Prüfberichte, DSGVO-Dokumentation, Compliance-Leitfäden und zugehörige Dokumente mit ausführlicheren Informationen zum Schutz Ihrer Daten durch Microsoft. Ihre Nutzung des Azure-Dienstes unterliegt den Servicebedingungen der Vereinbarung, unter der Sie die Dienste erworben haben. • Für Kunden, die ein Abonnement (einschließlich kostenloser Testversionen) online bei Microsoft erwerben oder verlängern, gilt entweder die Microsoft- Kundenvereinbarung („MCA“) oder die Microsoft Online-Abonnementvereinbarung („MOSA“). Ihre Nutzung unterliegt der letztgenannten Vereinbarung, wenn die MCA in Ihrer Region nicht verfügbar ist. Weitere Informationen zur Verfügbarkeit finden Sie auf der MCA-Seite. • Für Kunden, die über ein anderes kommerzielles Lizenzprogramm (z. B. ein Enterprise Agreement) erwerben, unterliegt die Nutzung dem Lizenzvertrag, unter dem Sie die Dienste erworben haben. Sie erhalten eine Kopie Ihres Lizenzvertrags von Ihrem Microsoft-Kundenbetreuer oder von der Abteilung für kommerzielle Lizenzierung. • Alle oben genannten Lizenzvereinbarungen umfassen die Website mit den Produktbedingungen und den Datenschutzzusatz zu Microsoft-Produkten und - Diensten („DPA“). Die Website mit den Produktbedingungen enthält Einzelheiten zu Verfügbarkeit, Nutzungsbedingungen und Datenschutz- /Sicherheitsverpflichtungen für Microsoft-Produkte und -Dienste, einschließlich Azure. Die Website mit den Produktbedingungen ersetzt die separaten Dokumente mit den Produktbedingungen und den Onlinedienstbedingungen. Alle Verweise auf die Produktbedingungen und/oder Onlinedienstbedingungen in den Lizenzvereinbarungen des Kunden beziehen sich nun auf die entsprechenden Abschnitte der Website mit den Produktbedingungen. • Wenn Sie kein Azure-Abonnement haben, unterliegt Ihre Nutzung der eingeschränkten Azure-Dienste, die ohne Abonnement genutzt werden können, den Nutzungsbedingungen von Microsoft."
  },
  {
    id: "real-match-311",
    topicId: "azure-verwaltung",
    prompt: "Ordnen Sie die Azure-Governance-Funktion der richtigen Beschreibung zu.",
    options: [
      { id: "A", text: "Beschränken Sie, welche virtuellen Maschinentypen in einem Abonnement erstellt werden können: Azure Blueprints. · Identifizieren Sie Azure-Ressourcen, die bestimmten Kostenstellen zugeordnet sind: Azure Policy. · Stellen Sie eine vollständige Azure-Anwendungsumgebung einschließlich Ressourcen bereit...: Azure Blueprints" },
      { id: "B", text: "Beschränken Sie, welche virtuellen Maschinentypen in einem Abonnement erstellt werden können: Azure Policy. · Identifizieren Sie Azure-Ressourcen, die bestimmten Kostenstellen zugeordnet sind: Azure-Tags. · Stellen Sie eine vollständige Azure-Anwendungsumgebung einschließlich Ressourcen bereit...: Azure Blueprints." },
      { id: "C", text: "Beschränken Sie, welche virtuellen Maschinentypen in einem Abonnement erstellt werden können: Azure-Ressourcensperren. · Identifizieren Sie Azure-Ressourcen, die bestimmten Kostenstellen zugeordnet sind: Azure-Richtlinien. · Stellen Sie eine vollständige Azure-Anwendungsumgebung einschließlich Ressourcen bereit...: Azure Blueprints" },
      { id: "D", text: "Beschränken Sie, welche virtuellen Maschinentypen in einem Abonnement erstellt werden können: Azure Blueprints. · Identifizieren Sie Azure-Ressourcen, die bestimmten Kostenstellen zugeordnet sind: Azure-Tags. · Stellen Sie eine vollständige Azure-Anwendungsumgebung einschließlich Ressourcen bereit...: Azure Policy" },
      { id: "E", text: "Beschränken Sie, welche virtuellen Maschinentypen in einem Abonnement erstellt werden können: Azure-Ressourcensperren. · Identifizieren Sie Azure-Ressourcen, die bestimmten Kostenstellen zugeordnet sind: Azure-Richtlinien. · Stellen Sie eine vollständige Azure-Anwendungsumgebung einschließlich Ressourcen bereit...: Azure-Tags" },
      { id: "F", text: "Beschränken Sie, welche virtuellen Maschinentypen in einem Abonnement erstellt werden können: Azure Policy. · Identifizieren Sie Azure-Ressourcen, die bestimmten Kostenstellen zugeordnet sind: Azure Blueprints. · Stellen Sie eine vollständige Azure-Anwendungsumgebung einschließlich Ressourcen bereit...: Azure-Ressourcensperren" },
    ],
    correct: "B",
  ...
  },
  {
    id: "real-match-310",
    topicId: "azure-verwaltung",
    prompt: "Ordnen Sie die serverlose Lösung der richtigen Eigenschaft zu.",
    options: [
      { id: "A", text: "Führt Code aus: Azure Functions · Ist immer zustandsbehaftet: Azure Functions · Läuft nur in der Cloud: Azure Logic Apps" },
      { id: "C", text: "Führt Code aus: Azure Functions · Ist immer zustandsbehaftet: Azure Logic Apps · Läuft nur in der Cloud: Azure Functions · Führt Code aus: Azure Logic Apps · Ist immer zustandsbehaftet: Azure Functions · Läuft nur in der Cloud: Azure Logic Apps" },
      { id: "D", text: "Führt Code aus: Azure Logic Apps · Ist immer zustandsbehaftet: Azure Logic Apps · Läuft nur in der Cloud: Azure Functions" },
    ],
    correct: "A",
  ...
  },
  {
    ...
    prompt: "Ordnen Sie die Vorteile des Cloud Computing den richtigen Beschreibungen zu.",
    options: [
      { id: "A", text: "P1: Agilität · P2: Geo-Verteilung · P3: Skalierbarkeit" },
      { id: "B", text: "P1: Agilität · P2: Skalierbarkeit · P3: Geo-Verteilung" },
      { id: "C", text: "P1: Geo-Verteilung · P2: Agilität · P3: Skalierbarkeit" },
      { id: "D", text: "P1: Geo-Verteilung · P2: Skalierbarkeit · P3: Agilität" },
      { id: "E", text: "P1: Skalierbarkeit · P2: Agilität · P3: Geo-Verteilung" },
      { id: "F", text: "P1: Skalierbarkeit · P2: Geo-Verteilung · P3: Agilität" },
    ],
    correct: "F",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Platzhalter 1: Azure SQL Data Warehouse · Platzhalter 2: Azure Data Lake Analytics · Platzhalter 3: Azure Data Lake Analytics · Platzhalter 4: Azure HDInsight" },
      { id: "B", text: "Platzhalter 1: Azure SQL-Datenbank · Platzhalter 2: Azure SQL Data Warehouse · Platzhalter 3: Azure Data Lake Analytics · Platzhalter 4: Azure HDInsight" },
      { id: "C", text: "Platzhalter 1: Azure SQL-Datenbank · Platzhalter 2: Azure SQL-Datenbank · Platzhalter 3: Azure SQL Data Warehouse · Platzhalter 4: Azure HDInsight" },
      { id: "D", text: "Platzhalter 1: Azure HDInsight · Platzhalter 2: Azure SQL-Datenbank · Platzhalter 3: Azure SQL Data Warehouse · Platzhalter 4: Azure SQL-Datenbank" },
      { id: "E", text: "Platzhalter 1: Azure SQL-Datenbank · Platzhalter 2: Azure HDInsight · Platzhalter 3: Azure Data Lake Analytics · Platzhalter 4: Azure HDInsight" },
      { id: "F", text: "Platzhalter 1: Azure HDInsight · Platzhalter 2: Azure SQL Data Warehouse · Platzhalter 3: Azure SQL Data Warehouse · Platzhalter 4: Azure HDInsight" },
    ],
    correct: "B",
  ...
  },
  {
    id: "real-match-105",
    topicId: "cloud-konzepte",
    prompt: "Ordnen Sie den Azure Cloud Services-Vorteil der richtigen Beschreibung zu.",
    options: [
      { id: "A", text: "Ein Cloud-Dienst, der auch nach einem Ausfall verfügbar bleibt: Fehlertoleranz. · Ein Cloud-Dienst, der nach einem Ausfall wiederhergestellt werden kann: Notfallwiederherstellung. · Ein Cloud-Dienst, der bei steigender Nachfrage schnell funktioniert: Dynamische Skalierbarkeit. · Ein Cloud-Dienst, auf den schnell über das Internet zugegriffen werden kann: Geringe Latenz." },
      { id: "D", text: "Ein Cloud-Dienst, der auch nach einem Ausfall verfügbar bleibt: Notfallwiederherstellung. · Ein Cloud-Dienst, der nach einem Ausfall wiederhergestellt werden kann: Fehlertoleranz. · Ein Cloud-Dienst, der bei steigender Nachfrage schnell arbeitet: Geringe Latenz. · Ein Cloud-Dienst, auf den schnell über das Internet zugegriffen werden kann: Geringe Latenz. · Ein Cloud-Dienst, der auch nach einem Ausfall verfügbar bleibt: Fehlertoleranz. · Ein Cloud-Dienst, der nach einem Ausfall wiederhergestellt werden kann: Notfallwiederherstellung. · Ein Cloud-Dienst, der bei steigender Nachfrage schnell funktioniert: Geringe Latenz. · Ein Cloud-Dienst, auf den schnell über das Internet zugegriffen werden kann: Dynamische Skalierbarkeit. · Ein Cloud-Dienst, der auch nach einem Ausfall verfügbar bleibt: Fehlertoleranz · Ein Cloud-Dienst, der nach einem Ausfall wiederhergestellt werden kann: Fehlertoleranz · Ein Cloud-Dienst, der bei steigender Nachfrage schnell funktioniert: Dynamische Skalierbarkeit · Ein Cloud-Dienst, auf den schnell über das Internet zugegriffen werden kann: Geringe Latenz" },
      { id: "E", text: "Ein Cloud-Dienst, der auch nach einem Ausfall verfügbar bleibt: Notfallwiederherstellung. · Ein Cloud-Dienst, der nach einem Ausfall wiederhergestellt werden kann: Notfallwiederherstellung. · Ein Cloud-Dienst, der bei steigender Nachfrage schnell funktioniert: Dynamische Skalierbarkeit. · Ein Cloud-Dienst, auf den schnell über das Internet zugegriffen werden kann: Geringe Latenz." },
      { id: "F", text: "Ein Cloud-Dienst, der auch nach einem Ausfall verfügbar bleibt: Notfallwiederherstellung. · Ein Cloud-Dienst, der nach einem Ausfall wiederhergestellt werden kann: Fehlertoleranz. · Ein Cloud-Dienst, der bei steigender Nachfrage schnell funktioniert: Dynamische Skalierbarkeit. · Ein Cloud-Dienst, auf den schnell über das Internet zugegriffen werden kann: Geringe Latenz." },
    ],
    correct: "A",
  ...
  },
  {
    ...
    prompt: "Ordnen Sie den Azure-Dienst der richtigen Beschreibung zu.",
    options: [
      { id: "A", text: "Platzhalter 1: Azure Machine Learning · Platzhalter 2: Azure Functions · Platzhalter 3: Azure AI Bot · Platzhalter 4: Azure IoT Hub" },
      { id: "B", text: "Platzhalter 1: Azure AI Bot · Platzhalter 2: Azure Machine Learning · Platzhalter 3: Azure Functions · Platzhalter 4: Azure IoT Hub" },
      { id: "C", text: "Platzhalter 1: Azure Functions · Platzhalter 2: Azure IoT Hub · Platzhalter 3: Azure IoT Hub · Platzhalter 4: Azure AI Bot" },
      { id: "D", text: "Platzhalter 1: Azure IoT Hub · Platzhalter 2: Azure Machine Learning · Platzhalter 3: Azure Machine Learning · Platzhalter 4: Azure Functions" },
      { id: "F", text: "Platzhalter 1: Azure AI Bot · Platzhalter 2: Azure Functions · Platzhalter 3: Azure Functions · Platzhalter 4: Azure IoT Hub · Platzhalter 1: Azure Functions · Platzhalter 2: Azure Functions · Platzhalter 3: Azure AI Bot · Platzhalter 4: Azure Machine Learning" },
    ],
    correct: "B",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Platzhalter 1: ISO · Platzhalter 2: NIST · Platzhalter 3: DSGVO · Platzhalter 4: Azure Government" },
      { id: "B", text: "Platzhalter 1: Azure Government · Platzhalter 2: ISO · Platzhalter 3: NIST · Platzhalter 4: GDPR" },
      { id: "C", text: "Platzhalter 1: ISO · Platzhalter 2: Azure Government · Platzhalter 3: NIST · Platzhalter 4: DSGVO" },
      { id: "D", text: "Platzhalter 1: Azure Government · Platzhalter 2: Azure Government · Platzhalter 3: ISO · Platzhalter 4: NIST" },
      { id: "E", text: "Platzhalter 1: NIST · Platzhalter 2: ISO · Platzhalter 3: DSGVO · Platzhalter 4: Azure Government" },
    ],
    correct: "A",
  ...
  },
  {
    id: "real-match-38",
    topicId: "azure-verwaltung",
    prompt: "Ordnen Sie den Azure-Dienst der richtigen Definition zu.",
    options: [
      { id: "A", text: "Platzhalter 1: Azure Functions · Platzhalter 2: Azure Applications Insights · Platzhalter 3: Azure Databricks · Platzhalter 4: Azure App Service" },
      { id: "C", text: "Platzhalter 1: Azure Databricks · Platzhalter 2: Azure Functions · Platzhalter 3: Azure Applications Insights · Platzhalter 4: Azure App Service · Platzhalter 1: Azure Functions · Platzhalter 2: Azure Databricks · Platzhalter 3: Azure Applications Insights · Platzhalter 4: Azure App Service" },
      { id: "D", text: "Platzhalter 1: Azure App Service · Platzhalter 2: Azure Applications Insights · Platzhalter 3: Azure Databricks · Platzhalter 4: Azure Databricks" },
      { id: "E", text: "Platzhalter 1: Azure Applications Insights · Platzhalter 2: Azure Databricks · Platzhalter 3: Azure App Service · Platzhalter 4: Azure App Service" },
      { id: "F", text: "Platzhalter 1: Azure Functions · Platzhalter 2: Azure Functions · Platzhalter 3: Azure Applications Insights · Platzhalter 4: Azure App Service" },
    ],
    correct: "C",
  ...
  },
  {
    id: "real-match-33",
    topicId: "azure-verwaltung",
    prompt: "Ordnen Sie die Azure-Dienste der richtigen Definition zu.",
    options: [
      { id: "A", text: "Platzhalter 1: Azure DevOps · Platzhalter 2: Azure Advisor · Platzhalter 3: Azure Cognitive Services · Platzhalter 4: Azure Applications Insights" },
      { id: "B", text: "Platzhalter 1: Azure DevOps · Platzhalter 2: Azure Cognitive Services · Platzhalter 3: Azure Advisor · Platzhalter 4: Azure Applications Insights" },
      { id: "C", text: "Platzhalter 1: Azure Advisor · Platzhalter 2: Azure DevOps · Platzhalter 3: Azure Applications Insights · Platzhalter 4: Azure Advisor" },
      { id: "D", text: "Platzhalter 1: Azure Advisor · Platzhalter 2: Azure DevOps · Platzhalter 3: Azure Cognitive Services · Platzhalter 4: Azure Applications Insights" },
      { id: "E", text: "Platzhalter 1: Azure DevOps · Platzhalter 2: Azure Applications Insights · Platzhalter 3: Azure Advisor · Platzhalter 4: Azure Cognitive Services" },
      { id: "F", text: "Platzhalter 1: Azure Cognitive Services · Platzhalter 2: Azure Advisor · Platzhalter 3: Azure Applications Insights · Platzhalter 4: Azure DevOps" },
    ],
    correct: "A",
