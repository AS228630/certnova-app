...
export const AZ900_QUESTIONS: PracticeQuestion[] = [
  ...
  },
  {
    ...
    instructions: "Ziehen Sie dazu den entsprechenden Azure-Dienst aus der linken Spalte in die rechte Beschreibung. Jeder Dienst kann einmal, mehrmals oder gar nicht verwendet werden. HINWEIS: Jede richtige Zuordnung zählt einen Punkt.",
    items: [
      { id: "devops", label: "Azure DevOps" },
      { id: "advisor", label: "Azure Advisor" },
      { id: "cognitive", label: "Azure Cognitive Services" },
      { id: "insights", label: "Azure Applications Insights" },
    ],
    descriptions: [
      { id: "d1", text: "Eine integrierte Lösung für die Bereitstellung von Code.", correctItemId: "devops" },
      { id: "d2", text: "Ein Tool, das Anleitung und Empfehlungen zur Verbesserung einer Azure-Umgebung bietet.", correctItemId: "advisor" },
  ...
  },
  {
    ...
    instructions: "Ziehen Sie dazu den entsprechenden Azure-Dienst aus der linken Spalte in die rechte Beschreibung. Jeder Dienst kann einmal, mehrmals oder gar nicht verwendet werden. HINWEIS: Jede richtige Auswahl zählt einen Punkt.",
    items: [
      { id: "functions", label: "Azure Functions" },
      { id: "databricks", label: "Azure Databricks" },
      { id: "insights", label: "Azure Applications Insights" },
      { id: "appservice", label: "Azure App Service" },
    ],
    descriptions: [
      { id: "d1", text: "Bietet die Plattform für serverlosen Code.", correctItemId: "functions" },
      { id: "d2", text: "Ein Big-Data-Analysedienst für maschinelles Lernen.", correctItemId: "databricks" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "C", text: "Mindestanzahl virtueller Maschinen: 3, Mindestanzahl Verfügbarkeitszonen: 3" },
      { id: "D", text: "Mindestanzahl virtueller Maschinen: 2, Mindestanzahl Verfügbarkeitszonen: 1" },
      { id: "E", text: "Mindestanzahl virtueller Maschinen: 1, Mindestanzahl Verfügbarkeitszonen: 2" },
    ],
    correct: "B",
  ...
  },
  {
    ...
    items: [
      { id: "item0", label: "Fehlertoleranz" },
      { id: "item1", label: "Notfallwiederherstellung" },
      { id: "item2", label: "Dynamische Skalierbarkeit" },
      { id: "item3", label: "Geringe Latenz" },
    ],
    descriptions: [
      { id: "d0", text: "Ein Cloud-Dienst, der auch nach einem Ausfall verfügbar bleibt", correctItemId: "item0" },
      { id: "d1", text: "Ein Cloud-Dienst, der nach einem Ausfall wiederhergestellt werden kann", correctItemId: "item1" },
      { id: "d2", text: "Ein Cloud-Dienst, der bei steigender Nachfrage schnell funktioniert", correctItemId: "item2" },
      { id: "d3", text: "Ein Cloud-Dienst, auf den schnell über das Internet zugegriffen werden kann", correctItemId: "item3" },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { id: "item2", label: "Marketplace" },
    ],
    descriptions: [
      { id: "d0", text: "Sicherheitsempfehlungen anzeigen", correctItemId: "item0" },
      { id: "d1", text: "Überwachen der Integrität von Azure-Diensten", correctItemId: "item1" },
      { id: "d2", text: "Durchsuchen der verfügbaren VM-Images", correctItemId: "item2" },
    ],
  ...
  },
  {
    ...
    descriptions: [
      { id: "d0", text: "Überwachen Sie Bedrohungen mithilfe von Sensoren", correctItemId: "item0" },
      { id: "d1", text: "Erzwingen Sie Azure MFA basierend auf einer Bedingung", correctItemId: "item1" },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { id: "item2", label: "Azure Data Lake Analytics" },
    ...
    explanation: "Azure Data Lake Analytics ist ein On-Demand-Analysedienst, der Big Data vereinfacht. Entwickeln und führen Sie mühelos massiv parallele Datentransformations- und -verarbeitungsprogramme in U-SQL, R, Python und .NET über Petabyte an Daten aus. Da Sie keine Infrastruktur verwalten müssen, können Sie Daten bedarfsgerecht verarbeiten, sofort skalieren und nur pro Auftrag bezahlen. Azure SQL Data Warehouse (SQL DW) ist ein analytisches MPP-Data Warehouse im Petabyte-Bereich, das auf SQL Server basiert und als Teil der Microsoft Azure Cloud Computing Platform ausgeführt wird. Wie andere Cloud-MPP-Lösungen trennt SQL DW Speicher und Rechenleistung und stellt beides separat in Rechnung. Azure SQL Database ist eine vollständig verwaltete Platform-as-a-Service (PaaS)-Datenbank-Engine, die die meisten Datenbankverwaltungsfunktionen wie Upgrades, Patches, Backups und Überwachung ohne Benutzereingriff übernimmt. Azure SQL Database läuft immer auf der neuesten stabilen Version der SQL Server-Datenbank-Engine und dem gepatchten Betriebssystem mit 99,99 % Verfügbarkeit. Dank der in Azure SQL Database integrierten PaaS-Funktionen können Sie sich auf die domänenspezifischen Datenbankverwaltungs- und - optimierungsaktivitäten konzentrieren, die für Ihr Unternehmen entscheidend sind. Azure Synapse Analytics ist ein integrierter Analysedienst, der schneller Erkenntnisse aus Data Warehouses und Big Data-Systemen gewinnt. Azure Synapse vereint die besten SQL-Technologien für Enterprise Data Warehousing, Spark-Technologien für Big Data und Pipelines für Datenintegration und ETL/ELT. Synapse Studio bietet eine einheitliche Oberfläche für Verwaltung, Überwachung, Codierung und Sicherheit. Synapse ist tief in andere Azure-Dienste wie PowerBI, CosmosDB und AzureML integriert. Azure Data Lake Analytics ist ein On-Demand-Analyseauftragsdienst, der Big Data vereinfacht. Entwickeln und führen Sie mühelos massiv parallele Datentransformations- und -verarbeitungsprogramme in U-SQL, R, Python und .NET über Petabyte an Daten aus. Da Sie keine Infrastruktur verwalten müssen, können Sie Daten nach Bedarf verarbeiten, sofort skalieren und nur pro Auftrag bezahlen. Azure HDInsight ist eine Cloud-Distribution von Hadoop-Komponenten. Azure HDInsight macht die Verarbeitung riesiger Datenmengen einfach, schnell und kostengünstig. Sie können die gängigsten Open-Source-Frameworks wie Hadoop, Spark, Hive, LLAP, Kafka, Storm, R und mehr verwenden. Mit diesen Frameworks können Sie eine breite Palette von Szenarien wie Extrahieren, Transformieren und Laden (ETL), Data Warehousing, maschinelles Lernen und IoT ermöglichen.",
  },
  {
    type: "yesno",
    id: "real-az900-205",
  ...
  },
  {
    ...
    id: "real-az900-269",
    topicId: "azure-verwaltung",
    prompt: "Ordnen Sie die Azure-Dienste den richtigen Beschreibungen zu. (Ziehen Sie dazu den entsprechenden Azure-Dienst aus der linken Spalte in die rechte Spalte. Jeder Dienst kann einmal, mehrmals oder gar nicht verwendet werden. HINWEIS: Jede richtige Zuordnung zählt einen Punkt.) Platzhalter 1: Azure Functions Platzhalter 2: Azure Machine Learning",
    items: [
      { id: "item0", label: "Azure Synapse Analytics" },
      { id: "item1", label: "Azure Machine Learning" },
      { id: "item2", label: "Azure Functions" },
      { id: "item3", label: "Azure IoT Hub" },
    ],
    descriptions: [
      { id: "d0", text: "Platzhalter 1", correctItemId: "item0" },
      { id: "d1", text: "Platzhalter 2", correctItemId: "item1" },
  ...
  },
  {
    ...
    id: "real-az900-311",
    topicId: "azure-verwaltung",
    prompt: "Ordnen Sie die Azure-Governance-Funktion der richtigen Beschreibung zu. (Ziehen Sie dazu die entsprechende Funktion aus der linken Spalte in die rechte Spalte. Jede Funktion kann einmal, mehrmals oder gar nicht verwendet werden. HINWEIS: Jede richtige Zuordnung zählt einen Punkt.)",
    items: [
      { id: "item0", label: "Azure Policy" },
      { id: "item1", label: "Azure-Tags" },
      { id: "item2", label: "Azure Blueprints" },
    ],
    descriptions: [
...

  {
    ...
    descriptions: [
      ...
      { id: "d1", text: "Schicht 2", correctItemId: "item1" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "C", text: "Reihenfolge: Georedundanter Speicher (GRS), Zonenredundanter Speicher (ZRS), Lokal redundanter Speicher (LRS)" },
      { id: "D", text: "Reihenfolge: Georedundanter Speicher (GRS), Lokal redundanter Speicher (LRS), Zonenredundanter Speicher (ZRS)" },
      { id: "E", text: "Reihenfolge: Lokal redundanter Speicher (LRS), Zonenredundanter Speicher (ZRS), Georedundanter Speicher (GRS)" },
      { id: "F", text: "Reihenfolge: Lokal redundanter Speicher (LRS), Georedundanter Speicher (GRS), Zonenredundanter Speicher (ZRS)" },
    ],
    correct: "E",
