...
//
// PROGRESS: questions 1-500 processed; 443 confidently verified and
// included, all QA-audited (zero duplicate-option/multi-colon/leading-
// artifact issues as of the last full re-scan). Skipped/removed 57 total —
// see git history for the exact breakdown per batch. Notably: Q429 is a
// full-page IMAGE-ONLY question (no extractable text at all) that could not
// be reliably read/transcribed — skipped rather than guessed; needs a
// clearer scan or manual transcription from the user.
// TODO next: extract 501-564 the same way (PDF pages 1-64) and append to
// this array with the same
