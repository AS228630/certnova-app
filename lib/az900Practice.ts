...
//
// PROGRESS: questions 1-300 processed; 285 confidently verified and
// included (15 "choose Ja/Nein for each statement" questions were SKIPPED
// because their answer grid was ambiguous to parse safely — better to omit
// than risk a wrong answer in a real exam-prep tool. Skipped: 31, 43, 44,
// 45, 104, 133, 166, 168, 169, 171, 221, 265, 282, 290, 295).
// TODO next: extract 301-400, 401-500, 501-564 the same way (PDF pages
// 165-264, 65-164, 1-64) and append to this array with the same
