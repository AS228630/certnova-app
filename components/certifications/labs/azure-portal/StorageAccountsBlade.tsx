...
export default function StorageAccountsBlade() {
  ...
  return (
    <div>
      <h2 className="mb-1 text-lg font-semibold text-[#201f1e]">Storage accounts</h2>
      ...
      <div className="overflow-hidden rounded border" style={{ borderColor: AZL.border }}>
        ...
        {storageAccounts.length === 0 ? (
          <div className="flex flex-col items-center gap-2 py-10 text-center">
            <Database size={28} style={{ color: AZL.textFaint }} />
          ...
          storageAccounts.map((sa) => (
            ...
            >
              ...
              <span className="text-[#201f1e]">{sa.resourceGroup}</span>
              <span className="text-[#201f1e]">{sa.location}</span>
              <button
