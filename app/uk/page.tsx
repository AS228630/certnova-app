...
export const metadata: Metadata = {
  title: "IT-сертифікації, мовні курси та коучинг зі ШІ | CertCoach",
  description:
    "Готуйся до сертифікацій AWS, Microsoft, Cisco та інших разом з CertCoach. Практичні лабораторні роботи, тренувальні питання, ШІ-коуч і структуровані навчальні шляхи — почни безкоштовно.",
  alternates: {
    canonical: "https://www.certcoach.de/uk",
    languages: {
...
const FEATURES = [
  { icon: BookOpen, title: "Навчання на практиці", desc: "Практичні лабораторні роботи та проєкти для реального досвіду." },
  { icon: ShieldCheck, title: "Визнані сертифікати", desc: "Міжнародно визнані сертифікати для твоєї кар'єри." },
  { icon: Sparkles, title: "ШІ-коуч", desc: "Твій особистий ШІ-коуч супроводжує тебе під час навчання." },
  { icon: Route, title: "Навчальні шляхи", desc: "Структуровані шляхи, розроблені для твого успіху." }
];
    ...
    <main dir="ltr" className="min-h-screen bg-[#0a0a12] text-white">
      <div className="mx-auto max-w-5xl px-6 py-20 text-center">
        <span className="mb-6 inline-block rounded-full border border-white/15 bg-white/5 px-4 py-1.5 text-xs font-semibold text-white/70">
          Платформа навчання IT №1 в DACH
        </span>
        <h1 className="font-bold text-4xl leading-tight sm:text-5xl">
          Твоє майбутнє починається
          <br />
          <span className="text-violet-400">з нових навичок</span>
        </h1>
        <p className="mx-auto mt-6 max-w-xl text-white/70">
          Вчись у експертів, отримуй визнані сертифікати та будуй кар&apos;єру, яку хочеш. Від Microsoft і AWS до CompTIA і Cisco.
        </p>
      ...
      <div className="mx-auto max-w-5xl px-6 pb-24">
        <h2 className="mb-8 text-center text-2xl font-bold">Чому CertCoach?</h2>
      ...
      <div className="border-t border-white/10 py-6 text-center text-xs text-white/40">
        <p>© 2026 CertCoach. Зроблено з ❤️ у Німеччині</p>
        <p className="mt-2">
