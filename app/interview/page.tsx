...
// "Karriere" nav link real destination: the whole page — including its
// interactive InterviewSidebar and mock-interview trigger — is real,
// guest-safe content (InterviewJobGrid/InterviewRecommendedCerts are
// pure data, no user dependency); only actually starting a mock
// interview session needs registration, handled inside
// InterviewPrepActions/MockInterviewModal, not by gating this whole
// page or showing a different layout for a Guest.

export default function InterviewPage() {
  // Real fix per explicit instruction: the "Karriere" page should show
  // the exact same real app shell (sidebar, search bar, real content)
  // for a Guest as for a signed-in user — not a visually different
  // marketing landing page. The only thing that changes for a Guest is
  // registration is required to actually start an interactive mock
  // interview (InterviewPrepActions/MockInterviewModal), never the page
  // layout itself.
  return (
