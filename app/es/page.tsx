...
export const metadata: Metadata = {
  title: "Certificaciones de TI, cursos de idiomas y coaching con IA | CertCoach",
  description:
    "Prepárate para certificaciones de AWS, Microsoft, Cisco y más con CertCoach. Laboratorios prácticos, preguntas de práctica, un coach de IA y rutas de aprendizaje estructuradas — empieza gratis.",
  alternates: {
    canonical: "https://www.certcoach.de/es",
    languages: {
...
const FEATURES = [
  { icon: BookOpen, title: "Aprende practicando", desc: "Laboratorios y proyectos prácticos para una experiencia real." },
  { icon: ShieldCheck, title: "Certificados reconocidos", desc: "Certificados reconocidos internacionalmente para tu carrera." },
  { icon: Sparkles, title: "Coach de IA", desc: "Tu coach de IA personal te acompaña mientras aprendes." },
  { icon: Route, title: "Rutas de aprendizaje", desc: "Rutas estructuradas diseñadas para tu éxito individual." }
];
    ...
    <main dir="ltr" className="min-h-screen bg-[#0a0a12] text-white">
      <div className="mx-auto max-w-5xl px-6 py-20 text-center">
        <span className="mb-6 inline-block rounded-full border border-white/15 bg-white/5 px-4 py-1.5 text-xs font-semibold text-white/70">
          Plataforma de aprendizaje de TI n.º 1 en DACH
        </span>
        <h1 className="font-bold text-4xl leading-tight sm:text-5xl">
          Tu futuro comienza
          <br />
          <span className="text-violet-400">con nuevas habilidades</span>
        </h1>
        <p className="mx-auto mt-6 max-w-xl text-white/70">
          Aprende de expertos, obtén certificados reconocidos y construye la carrera que quieres. De Microsoft y AWS a CompTIA y Cisco.
        </p>
      ...
      <div className="mx-auto max-w-5xl px-6 pb-24">
        <h2 className="mb-8 text-center text-2xl font-bold">¿Por qué CertCoach?</h2>
      ...
      <div className="border-t border-white/10 py-6 text-center text-xs text-white/40">
        <p>© 2026 CertCoach. Hecho con ❤️ en Alemania</p>
        <p className="mt-2">
