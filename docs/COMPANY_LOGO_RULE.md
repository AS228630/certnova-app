...
| `public/logos/companies/deutschebahn.svg` | [simple-icons](https://github.com/simple-icons/simple-icons) npm package v16.28.0, CC0-1.0 licensed, verified against Deutsche Bahn's official brand guidelines | Generic Deutsche Bahn wordmark — for the Deutsche Bahn AG experience entry |
| `public/logos/companies/itmo-university.png` | Cropped from [Wikimedia Commons File:ITMO_University_official_logo_horizontal.png](https://commons.wikimedia.org/wiki/File:ITMO_University_official_logo_horizontal.png) (page metadata: Source `ifmo.ru`, Author "ITMO University", labeled official logo) | For the ITMO University education entry |
